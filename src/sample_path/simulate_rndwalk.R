...
rndwalk <- function(smpl_size = 1, delta = .01, sigma = 1, beta = .75, 
  ...
  # Purpose: random walk simulation of a bounded Wiener process
  # Inputs: integer scalar smple_size, double scalars delta, sigma, beta,
  #         alpha, low_bound, time_unit
  # Outputs: double vector path_smpl
